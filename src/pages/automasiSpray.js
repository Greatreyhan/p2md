...
const calculateTimeLeft = ()=>{
  ...
  return (
    <div className='w-10/12 mx-auto pt-20'>
      ...
      {/* Weather */}
      {data ? 
        <div className='w-8/12 rounded-xl py-2 px-8 mx-auto'>
            <div>
